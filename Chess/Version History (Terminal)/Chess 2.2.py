...
def OwnKingInCheck(game,turn,piece,r_piece,c_piece,move,r_move,c_move,movesplayed):
    pass
...
def CheckEnemyKing(game,turn,piece,r_piece,c_piece,move,r_move,c_move,enemy_kingpos,movesplayed,event):
    ...
    if r_king == c_king and r_king == 0:
        for i in range(1,8):
            if game[r_king+i][c_king] == turn_pieces[turn][0]:
                break
            elif game[r_king+i][c_king] == '-':
                continue
            elif game[r_king+i][c_king] == turn_pieces[1-turn][0]:
                event = '+'
                return event
        for i in range(1,8):
            if game[r_king][c_king+i] == turn_pieces[turn][0]:
                break
            elif game[r_king][c_king+i] == '-':
                continue
            elif game[r_king][c_king+i] == turn_pieces[1-turn][0]:
                event = '+'
                return event
        for i in range(1,8):
            if game[r_king+i][c_king+i] == turn_pieces[turn][2]:
                break
            elif game[r_king+i][c_king+i] == '-':
                continue
            elif game[r_king+i][c_king+i] == turn_pieces[1-turn][2]:
                event = '+'
                return event
