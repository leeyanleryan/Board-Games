...
def CornerChecks(game,turn,r_king,c_king,event):
    r_mul, c_mul = int((r_king-3.5)//-3.5), int((c_king-3.5)//-3.5)
    for i in range(1,8):
        if game[r_king+i*r_mul][c_king] in turn_pieces[turn]:
            break
        elif game[r_king+i*r_mul][c_king] == '-':
            continue
        elif game[r_king+i*r_mul][c_king] in turn_pieces[1-turn] and game[r_king+i*r_mul][c_king] != turn_pieces[1-turn][0] and game[r_king+i*r_mul][c_king] != turn_pieces[1-turn][3]:
            break
        elif game[r_king+i*r_mul][c_king] == turn_pieces[1-turn][0] or game[r_king+i*r_mul][c_king] == turn_pieces[1-turn][3]:
            return '+'
    for i in range(1,8):
        if game[r_king][c_king+i*c_mul] in turn_pieces[turn]:
            break
        elif game[r_king][c_king+i*c_mul] == '-':
            continue
        elif game[r_king+i*r_mul][c_king] in turn_pieces[1-turn] and game[r_king][c_king+i*c_mul] != turn_pieces[1-turn][0] and game[r_king][c_king+i*c_mul] != turn_pieces[1-turn][3]:
            break
        elif game[r_king][c_king+i*c_mul] == turn_pieces[1-turn][0] or game[r_king][c_king+i*c_mul] == turn_pieces[1-turn][3]:
            return '+'
    for i in range(1,8):
        if game[r_king+i*r_mul][c_king+i*c_mul] in turn_pieces[turn]:
            break
        elif game[r_king+i*r_mul][c_king+i*c_mul] == '-':
            continue
        elif game[r_king+i*r_mul][c_king+i*c_mul] in turn_pieces[1-turn] and game[r_king+i*r_mul][c_king+i*c_mul] != turn_pieces[1-turn][2] and game[r_king+i*r_mul][c_king+i*c_mul] != turn_pieces[1-turn][3]:
            break
        elif game[r_king+i*r_mul][c_king+i*c_mul] == turn_pieces[1-turn][2] or game[r_king+i*r_mul][c_king+i*c_mul] == turn_pieces[1-turn][3]:
            return '+'
    return 'none'
...
def CheckEnemyKing(game,turn,piece,r_piece,c_piece,move,r_move,c_move,enemy_kingpos,movesplayed,event):
    ...
    if r_king == c_king and r_king == 0:
        event = CornerChecks(game,turn,r_king,c_king,event)
        if game[r_king+1][c_king+2] == turn_pieces[1-turn][1] or game[r_king+2][c_king+1] == turn_pieces[1-turn][1]:
            event = '+'
        return event
    elif r_king == 0 and c_king == 7:
        event = CornerChecks(game,turn,r_king,c_king,event)
        if game[r_king+1][c_king-2] == turn_pieces[1-turn][1] or game[r_king+2][c_king-1] == turn_pieces[1-turn][1]:
            event = '+'
        return event
    elif r_king == 7 and c_king == 0:
        event = CornerChecks(game,turn,r_king,c_king,event)
        if game[r_king-1][c_king+2] == turn_pieces[1-turn][1] or game[r_king-2][c_king+1] == turn_pieces[1-turn][1]:
            event = '+'
        return event
    elif r_king == c_king and r_king == 7:
        event = CornerChecks(game,turn,r_king,c_king,event)
        if game[r_king-1][c_king-2] == turn_pieces[1-turn][1] or game[r_king-2][c_king-1] == turn_pieces[1-turn][1]:
            event = '+'
        return event
...
##            return '+' 
    ...
    # Can use below?
    # LegalRookMovement(game,turn,piece,r_piece,c_piece,move,r_move,c_move,movesplayed)
    # LegalKnightMovement(game,turn,piece,r_piece,c_piece,move,r_move,c_move,movesplayed)
    # LegalBishopMovement(game,turn,piece,r_piece,c_piece,move,r_move,c_move,movesplayed)
